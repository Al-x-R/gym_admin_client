          ...
          >
            <Box pt="5" pb="6" px="5">
              ...
              <SimpleGrid as="nav" gap="6" mt="8" columns={{ base: 1, sm: 2 }}>
                <NavLink.Mobile icon={HiCurrencyDollar}>Memberships</NavLink.Mobile>
                <NavLink.Mobile icon={HiCurrencyDollar}>Clients</NavLink.Mobile>
                <NavLink.Mobile icon={HiCurrencyDollar}>Trainers</NavLink.Mobile>
                <NavLink.Mobile icon={HiCurrencyDollar}>Workouts</NavLink.Mobile>
              </SimpleGrid>
